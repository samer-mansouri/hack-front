      ...
      <main className="lg:relative">
        <div className="mx-auto max-w-8xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
          <div className="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              ...
              <span className="block text-[#3b82f6] xl:inline">créer un impact</span>
            </h1>
            ...
            <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
              <div className="rounded-md shadow">
                <a
                  href="#"
                  className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#3b82f6] hover:bg-[#3b82f6] md:py-4 md:text-lg md:px-10"
                >
                    Commencer
                </a>
              </div>
        ...
        <div className="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full">
          <img
            ...
            src="https://www.a-speakers.com/wp-content/uploads/hands-600497_1920.jpg"
            alt=""
          />
        </div>
      </main>
